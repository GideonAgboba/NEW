...
if ( $result->num_rows == 0 ){ // User doesn't exist
    $_SESSION['message'] = "User with that email doesn't exist. Please sign-up if you havent created an account!";
...
mysqli_query($connect, $create); 
        ...
        $_SESSION['message'] = "You have entered wrong password, try again or reset passord if you have fogotten your passowrd!";
        header("Location: error.php");
    }
}
